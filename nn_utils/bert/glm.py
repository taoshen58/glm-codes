...
class BertForGLM(BertPreTrainedModel):
    MAX_SEQ_LENGTH = 512
    ...
    def forward(
        ...
        # MLM loss
        mlm_score_bert = self.cls(sequence_output)
    ...
    def generate_reversed_positional_ids(self, node_ids):
        ...
        position_ids = torch.arange(start_index,
                                    seq_length + start_index,
                                    dtype=torch.long,
