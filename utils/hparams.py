...
def define_hparams_bert(parser):
...
def define_hparams_preproc(parser):
...
def define_hparams_pipeline_base(parser):
    define_hparams_bert(parser)
    define_hparams_io(parser)
    define_hparams_preproc(parser)
